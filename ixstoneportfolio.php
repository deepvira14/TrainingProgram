            ...
            <section class="portfolio-single style-basic">
                <div class="portfolio-single-content">
                    ...
                    <div class="flexslider post-gallery margin_b_40">
                        <ul class="slides">
                            <li><img src="image/ixstone.jpg" alt=""></li>
                            <li><img src="image/ixstoneservices.jpg" alt=""></li>
                            <li><img src="image/ixstonehalloffame.png" alt=""></li>
                        </ul>
                    </div>
                ...
                <div class="portfolio-single-details">
                    ...
                    <a href="http://ixstone.com/index.html" class="portfolio-website-button button bg-dark-gray color-white">View Website</a>
