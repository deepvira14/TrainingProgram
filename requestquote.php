...
error_reporting(E_ALL);
    ...
    $mail->AddAddress("kunjshah45@gmail.com", "Marketing");// this mail be received to the emailid written here
    $mail->AddReplyTo("marketing.project.cse@gmail.com", "Marketing");
    $mail->IsHTML(true); // set email format to HTMl
    $mail->Subject = 'Request For Quote';
    
    $mail->Body="Name: ".$name."<br>"."Email: ".$email."<br>"."Mobile: ".$mobile."<br>"."URL:".$url."<br>"."Message:".$message;
    if($mail->Send()) 
    {
        $reply="We have got your Request regarding Quote. Our Team will get back to you soon .";
...
<body class="headerstyle6 headerfixed ">
    ...
    <div id="splendid-content">
        ...
        <section class="section full-width full-height color-light bg-black padding_t_100 padding_b_90" style="background-image:url(img/team/bg.jpg);">
            <div class="container">
            ...
            <div class="alert-box success">
              ...
              <p><?php echo $reply;?></p>
            <center>
              <a href="index.php" class="button unfilled br-light br-color-black color-black">Go Back to the homepage.</a>
            </center>
            </div>
          </div>
            </div>
