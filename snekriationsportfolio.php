            ...
            <section class="portfolio-single style-basic">
                <div class="portfolio-single-content">
                    ...
                    <div class="flexslider post-gallery margin_b_40">
                        <ul class="slides">
                            <li><img src="image/snekriations.jpg" alt=""></li>
                            <li><img src="image/snekriationscontactus.jpg" alt=""></li>
                            <li><img src="image/snekriationsgallery.jpg" alt=""></li>
                        </ul>
                    </div>
                ...
                <div class="portfolio-single-details">
                    ...
                    <a href="http://snekriations.com/index.php" class="portfolio-website-button button bg-dark-gray color-white">View Website</a>
