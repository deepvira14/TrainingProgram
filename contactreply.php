        ...
        <main id="splendid-main-container" class="container page-layout">
            ...
            <div class="main-content">
                ...
                <div class="main-content">
                    ...
                    <p>Praesent pharetra in felis ac dictum. Mauris ut ervarius, tempor sem in, vestibulum nisl. Nam euismod, elit ac vehicula vulputate, sapien ligula lobortis turpis, non rhoncus nisl odio vitae lectus. Quisque iaculis lorem vestibulum eros vehicula, congue elit dictum. </p>
                    
                    <div class="divider margin_t_60 margin_b_60"></div>
            ...
            <div class="sidebar-container">
                ...
                <div class="sidebar_widget widget widget_text">
                    <ul class="iconic-list style2">
                        <li><i class="fa fa-map-marker"></i><p><strong>Address: </strong><br>
                                        A/24 Silver Gold Apt,<br>
                                        Mandpeshwar Road,</br>
                                        Borivali (w) , Mumbai- 400092 </p></li>
                        <li><i class="fa fa-envelope-o"></i>      <strong>E-mail:</strong> info@snekriations.com<br></li>
                        <li><i class="fa fa-phone"></i> <p><strong>Phone:</strong><br>
                                         Snehal Shah +91 8879961775<br>
                                         Snehal Shah +91 8879961775<br></p></li>
                    </ul>
                </div>
                <!-- /Contact Widget -->
                
                <!-- Social Media Widget -->
                <div class="sidebar_widget widget widget_social_media">
                    <h5>Find us on</h5>
