            ...
            <section class="portfolio-single style-basic">
                <div class="portfolio-single-content">
                    ...
                    <div class="flexslider post-gallery margin_b_40">
                        <ul class="slides">
                            <li><img src="image/limelight.jpg" alt=""></li>
                            <li><img src="image/limelightservices.jpg" alt=""></li>
                            <li><img src="image/limelightcontactus.jpg" alt=""></li>
                        </ul>
                    </div>
                ...
                <div class="portfolio-single-details">
                    ...
                    <a href="http://limelight.co.in/index.php" class="portfolio-website-button button bg-dark-gray color-white">View Website</a>
