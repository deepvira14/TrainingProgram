...
<div class="col-lg-6 col-md-6">
                    ...
                    <form class="contact-form" action="carrersreply.php"  method="post" enctype="multipart/form-data">
                        <div class="row">
                        ...
                        <input type="file" name="document" style="width:40%;" class="w3-hover-border-black"/><br><br>
